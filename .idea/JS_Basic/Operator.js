...
// comparison operators --> boolean values
 ...
 console.log(1==1);
 console.log(1=="1");//in == equal to he check only value
 console.log(1==="1"); // in === he check vale with type
...
console.log('kunal'=='kunal');
 ...
 console.log(null===null);
 console.log(undefined == 'undefined'); // he checks type
 console.log(undefined === 'undefined');

 console.log(true == "1");
 console.log(true === "1");

 console.log(1!= "2"); //check only for value
 console.log(1!== 2); // check type and value
...
var timeTakenInSec = 30;

const result2 = passingMarks>=60 || timeTakenInSec<30 ? 'pass':'fail';
console.log(result2);
